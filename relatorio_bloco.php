	...
	<body>
		...
		<div id="banner">
			...
			<div id="pagina">
				...
				<div id="conteudo">
					<div class="caixa">
					<h3>Bloco: <?php echo $bloco?></h3>
					<ul>
						<li>Total de Disciplinas no Bloco:
							<p style="color: blue"><?php
							$resultado = mysql_query("SELECT COUNT(DISTINCT sd.ID_DISCIPLINA ) AS COUNT
							...
							?></p>
							<li>Total de Salas Disponíveis no Bloco
							<p style="color: blue"><?php
							$resultado = mysql_query("SELECT COUNT(DISTINCT ID_SALA) as COUNT
							FROM disciplina d, semana_disciplina sd, sala s
							WHERE d.ID_DISCIPLINA = sd.ID_DISCIPLINA
							AND sd.ID_SALA = s.ID
							AND BLOCO = '$bloco'");
